...
ActiveRecord::Schema.define(:version => 20081222093204) do

  create_table "games", :force => true do |t|
    t.integer  "owner_id",                   :limit => 11
    t.integer  "length",                     :limit => 11, :default => 12
    t.integer  "status",                     :limit => 11, :default => 0
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "current_player_id",          :limit => 11
    t.datetime "finished_at"
    t.string   "name"
    t.integer  "thumbnail_post_id",          :limit => 11
    t.integer  "comment_count",              :limit => 11, :default => 0,  :null => false
    t.datetime "last_comment_at"
    t.datetime "published_at"
    t.integer  "featured_thumbnail_post_id", :limit => 11
    t.integer  "last_player_id",             :limit => 11
    t.integer  "second_last_player_id",      :limit => 11
  ...
  create_table "players", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "order_position", :limit => 11, :null => false
  end
  ...
  create_table "users", :id => false, :force => true do |t|
    t.integer  "facebook_id", :limit => 11, :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
